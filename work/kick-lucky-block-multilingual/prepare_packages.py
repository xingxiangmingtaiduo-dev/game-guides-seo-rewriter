...
LANG={"Traditional-Chinese":"繁體中文","English":"English","Portuguese":"Português","Spanish":"Español","Thai":"ภาษาไทย","Indonesian":"Bahasa-Indonesia","Vietnamese":"Tiếng-Việt"};K={"slug":"Slug","seo_title":"SEO Title","primary_keyword":"Primary Keyword","secondary_keywords":"Secondary Keywords","meta_description":"Meta Description","tags":"Tags","body_length_target":"Body Length Target","output_language":"Output Language"}
def p(t):
 m=re.match(r'^---\n(.*?)\n---\n\n(.*)$',t,re.S);d={}
